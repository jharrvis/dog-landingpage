...
// Get theme mod values with defaults
$hero_title_1 = get_theme_mod('hero_title_line1', 'Is your dogs');
$hero_title_2 = get_theme_mod('hero_title_line2', 'life worth');
$hero_title_highlight = get_theme_mod('hero_title_highlight', '135.00?');
$hero_subtitle = get_theme_mod('hero_subtitle', "Don't let an outdoor adventure turn into a 2am tragedy. Protect them before it's too late.");
$hero_btn_text = get_theme_mod('hero_btn_text', 'Secure Your Slot 🐾');
$hero_btn_link = get_theme_mod('hero_btn_link', 'https://calendly.com/olk9training/rattlesnake-avoidance-course-2026');
$hero_video_id = get_theme_mod('hero_video_id', 'tzA0RzvcJwU');
$facts_stat_1_number = get_theme_mod('facts_stat_1_number', '~7,000–8,000 dogs');
$facts_stat_1_text = get_theme_mod('facts_stat_1_text', 'are bitten by rattlesnakes in the U.S. every year');
$vet_treatment_price = get_theme_mod('vet_treatment_price', '$3,000–$7,000');
$vet_severe_price = get_theme_mod('vet_severe_price', '$10,000–$15,000+');
$cta_headline_start = get_theme_mod('cta_headline_start', 'The first 50 dogs get in at:');
$cta_price_main = get_theme_mod('cta_price_main', '135');
$cta_price_decimal = get_theme_mod('cta_price_decimal', '.00');
    ...
    <div
        ...
        <div class="z-10 lg:col-span-2 text-center lg:text-left w-full" data-aos="fade-right">
            <h1
                ...
                <?php echo esc_html($hero_title_1); ?> <br class="hidden sm:block">
                <?php echo esc_html($hero_title_2); ?> <br class="hidden sm:block">
                <span class="text-orange-custom"><?php echo esc_html($hero_title_highlight); ?></span>
            </h1>
        ...
        <div class="relative flex flex-col items-center lg:items-end justify-center w-full lg:col-span-3"
            ...
            <div class="text-center lg:text-right mb-4 lg:mb-2 w-full">
                ...
                <p class="text-orange-custom text-2xl sm:text-3xl lg:text-2xl mt-1 font-bold font-display">For your dog
                </p>
            </div>
            ...
            <div class="relative z-10 w-full aspect-video rounded-3xl overflow-hidden shadow-2xl bg-dark"
                ...
                <iframe class="w-full h-full"
                    src="https://www.youtube.com/embed/<?php echo esc_attr($hero_video_id); ?>?autoplay=1&mute=1&rel=0&loop=1&playlist=<?php echo esc_attr($hero_video_id); ?>"
...
<section id="facts" class="py-24 bg-[#0F2C59] relative overflow-hidden">
    <div class="absolute -right-48 -top-24 pointer-events-none opacity-10 z-0">
        <img src="<?php echo esc_url($theme_uri); ?>/assets/img/rattlesnakes-sign.webp" alt=""
    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-10 relative z-10">
        <div class="grid lg:grid-cols-3 gap-8 items-end">
            <div class="lg:col-span-2">
                <div
                    ...
                    <div>
                        ...
                        <p class="text-gray-300 max-w-md mx-auto lg:mx-0">Key figures every dog owner should know.</p>
                    </div>
                </div>
            ...
            <div class="lg:col-span-1 relative h-full min-h-[400px] lg:min-h-[650px] block" data-aos="fade-left">
                <img src="<?php echo esc_url($theme_uri); ?>/assets/img/tom-mcgovern.webp" alt="Tom McGovern"
                ...
                <div class="space-y-4">
                    ...
                    <div
                        ...
                        <div class="flex items-center gap-4">
                            ...
                            <div class="flex-1">
                                <p class="text-sm font-semibold text-gray-500 uppercase tracking-wide">Severe Cases</p>
                                <p class="text-2xl font-bold text-red-600"><?php echo esc_html($vet_severe_price); ?>
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div>
                    ...
                    <ul class="space-y-6 mb-10">
                        <li class="flex gap-4 items-start">
                            ...
                            <p class="text-lg leading-relaxed">Is $135 worth your dog's life?</p>
                        </li>
                        <li class="flex gap-4 items-start" data-aos="fade-left" data-aos-delay="600">
                            ...
                            <p class="text-lg leading-relaxed">Is $135 worth avoiding a $7,000 emergency bill?</p>
                        </li>
                        <li class="flex gap-4 items-start" data-aos="fade-left" data-aos-delay="700">
                            ...
                            <p class="text-lg leading-relaxed">Is $135 worth not having to decide how much your dog is
                                "worth" at 2am?</p>
                        </li>
                    </ul>
        ...
        <div class="columns-1 md:columns-2 lg:columns-3 gap-8 space-y-8">
            ...
            foreach ($gallery_images as $index => $img): ?>
                <div class="break-inside-avoid rounded-3xl overflow-hidden border-4 border-white shadow-xl hover:scale-[1.02] transition-transform duration-300"
                    ...
                    <img src="<?php echo esc_url($theme_uri); ?>/assets/img/gallery/<?php echo esc_attr($img); ?>"
    ...
    <div class="container mx-auto px-10">
        ...
        <div class="grid md:grid-cols-3 gap-8">
            <div class="p-10 rounded-[40px] border-none bg-white shadow-lg">
                ...
                <p class="text-xl font-medium italic mb-6 text-[#0F2C59]">"I didn't think it would happen to my dog"</p>
            </div>
            ...
            <div class="p-10 rounded-[40px] border-none bg-white shadow-lg">
                <div class="text-5xl mb-6 text-orange-custom">"</div>
                <p class="text-xl font-medium italic mb-6 text-[#0F2C59]">"I was going to sign up next month"</p>
            </div>
        </div>
    </div>
</section>
            ...
            <div class="rounded-none sm:rounded-[40px] overflow-hidden" data-aos="zoom-in">
                <div class="p-8 sm:p-10 text-center">
                    ...
                    <div
                        ...
                        <span class="text-white text-sm font-bold uppercase tracking-wider">Limited Time Offer</span>
                    </div>
                </div>
                    ...
                    <div
                        ...
                        <div class="w-full text-center">
                            ...
                            <div class="flex items-baseline justify-center">
                                ...
                                <span
                                    class="text-[#0F2C59] text-3xl font-bold"><?php echo esc_html($cta_price_decimal); ?></span>
                            </div>
                            <p class="text-gray-500 text-xs mt-2 leading-relaxed mx-auto">
                                After that, price goes to $150.<br>
                                <span class="text-red-500 font-bold">When spots are gone, they're gone.</span>
                            </p>
                        </div>
                    </div>
                    <a href="<?php echo esc_url($hero_btn_link); ?>"
...
<section id="schedule" class="py-24 bg-white relative">
    <div class="container mx-auto px-10 text-center">
        <h2 class="text-4xl font-bold uppercase mb-12 text-[#0F2C59]">Select Your <span
                class="text-orange-custom">Training Experience</span></h2>
